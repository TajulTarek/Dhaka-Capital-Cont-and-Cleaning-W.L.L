...
export const SERVICES: ServiceData[] = [
  ...
  /* ── 5. MEP Works ──────────────────────────────────────────────────── */
  {
    ...
    tagline: "Strong, precise, and long-lasting MEP works delivered with expert engineering and modern installation techniques.",
    heroDescription:
    ...
    craftingBody:
      "At Dhaka Capital, MEP work is a core part of our engineering expertise. We deliver projects that combine precise installation, safe operation, and long-lasting performance. From electrical and plumbing to HVAC, fire systems, and mechanical services, our team ensures every system is installed to the highest technical standards.\n\nWe believe quality MEP work is more than installation — it's about strong planning, accurate execution, and systems that enhance both functionality and safety. Our process uses certified materials, skilled technicians, and proven engineering practices to achieve reliable results that meet client expectations and stand the test of time.",
    metaDescription:
      "Professional MEP works in Doha, Qatar. Electrical, plumbing, HVAC, fire fighting systems by Dhaka Capital.",
    icon: "Zap",
  },
